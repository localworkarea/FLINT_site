(() => {
    ...
    const enableSwiper = function() {
        mySwiper = new core(".fourth-slide__slider", {
    ...
    class FullPage {
        ...
        styleFade() {
            for (let index = 0; index < this.sections.length; index++) {
                ...
                let timeline = gsapWithCSS.timeline({
                    paused: true
                });
                ...
                let tlGrenka = gsapWithCSS.timeline({
                    paused: true
                });
                mm.add("(min-width: 1201px)", (() => {
                ...
                let tlPackages = gsapWithCSS.timeline({
                    paused: true
                });
                mm.add("(min-width: 769px)", (() => {
                ...
                let tlOpen = gsapWithCSS.timeline({
                    paused: true
                });
                mm.add("(min-width: 1201px)", (() => {
        ...
        touchMove(e) {
            ...
            if (this.goScroll && Math.abs(yCoord) > 70) this.choiceOfDirection(yCoord);
        }
        touchUp(e) {
